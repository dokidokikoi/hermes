...
func TestTwoDFan_SearchGame(t *testing.T) {
...
func TestMain(t *testing.T) {
	...
	}).Get("https://2dfan.com/subjects/SearchGame?keyword=%E3%83%9C%E3%82%AF%E3%81%AE%E5%BD%BC%E5%A5%B3")
	if err != nil {
		t.Fatal(err)
	}
...
func TestTwoDFan_GetItemLinks(t *testing.T) {
	items, err := twoDFanScraper.SearchGame("ボクの彼女はガテン系", 1)
	if err != nil {
		panic(err)
	}
